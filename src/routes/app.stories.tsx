          ...
          >
            <div className="relative h-52">
              ...
              <div className="absolute bottom-0 inset-x-0 p-5">
                <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full glass-strong text-[10px] text-[var(--gold)]">
            ...
            <div className="p-5 bg-card/40">
              <p className="text-sm text-white/70 leading-relaxed">{s.excerpt}</p>
              <button className="mt-4 text-xs text-[var(--gold)] font-medium">اقرأ القصة كاملة →</button>
            </div>
          </motion.article>
        ))}
      </div>
